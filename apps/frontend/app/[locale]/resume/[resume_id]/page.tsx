...
export default function ResumeDetailPage() {
  ...
  const resume_id = (params?.resume_id as string) || '';
  ...
  }, [jobDescription, resume_id, t, session, router, locale]);
  ...
  useEffect(() => { 
    ...
    getResume(resume_id)
      ...
      .catch(e => {
        ...
        // Don't require authentication for viewing resumes
        console.warn('Resume loading failed:', errorMessage);
        setError('Fehler beim Laden des Lebenslaufs: ' + errorMessage);
      })
